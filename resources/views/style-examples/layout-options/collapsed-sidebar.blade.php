            ...
            <ul class="sidebar-menu">
              ...
              <span class="label label-primary pull-right">4</span>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="/collapsed-sidebar"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a>
                        </li>
                    </ul>
                </li>
                <li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/forms-example"><i class="fa fa-circle-o"></i> General Elements</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/400-example"><i class="fa fa-circle-o"></i> 404 Error</a></li>
