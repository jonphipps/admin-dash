            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/admin-index"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
              ...
              <span class="label label-primary pull-right">4</span>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="/boxed"><i class="fa fa-circle-o"></i> Boxed</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/chart-js"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                        <li><a href="/morris"><i class="fa fa-circle-o"></i> Morris</a></li>
                        <li><a href="/flot"><i class="fa fa-circle-o"></i> Flot</a></li>
                        <li><a href="inline-chart"><i class="fa fa-circle-o"></i> Inline charts</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/iconsl"><i class="fa fa-circle-o"></i> Icons</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/500-exmaple"><i class="fa fa-circle-o"></i> 500 Error</a></li>
                        <li><a href="/blank-page"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                        <li><a href="/page-pace"><i class="fa fa-circle-o"></i> Pace Page</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
